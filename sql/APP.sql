...
VALUES ('ce60006c-4fc9-4012-a96c-94174709723e','Iapó App','CrosierApp para a Iapó','8a01fa79-d5d1-487d-979a-508cc9b7a3ac',now(),now(),1,1,1);
...
VALUES ('e6e9863d-61cd-47a9-8e7b-654fd3922776','Dashboard - Iapó', '/', 'ce60006c-4fc9-4012-a96c-94174709723e', null, now(), now(), 1, 1, 1);
...
VALUES ('bf80f720-ac8e-47bd-9a0f-9e7c33dce84c','Dashboard - Iapó','fas fa-columns','CROSIERCORE_APPENT','e6e9863d-61cd-47a9-8e7b-654fd3922776',null,0,null,now(),now(),1,1,1);

-- Entrada de menu raíz para este CrosierApp (NÃO É EXIBIDO)
INSERT INTO cfg_entmenu(uuid,label,icon,tipo,program_uuid,pai_uuid,ordem,css_style,inserted,updated,estabelecimento_id,user_inserted_id,user_updated_id)
VALUES ('8a01fa79-d5d1-487d-979a-508cc9b7a3ac','Iapó - MainMenu','','PAI','',null,0,null,now(),now(),1,1,1);
